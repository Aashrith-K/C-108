...
function startClassification()
{
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/4CgcwI7VH/model.json', modelready);
}
function modelready()
{
...
function gotResults(error, results)
{
    ...
    else
    {
        ...
        document.getElementById("animal_voices").innerHTML = "Detected Voce is Of - " + results[0].label;
        ...
        {
            img.src = "https://www.bing.com/th/id/OGC.ed424ce7e8aa8e8ea5909c5ec394be07?pid=1.7&rurl=http%3a%2f%2fwww.clipartbest.com%2fcliparts%2fKTj%2fXXX%2fKTjXXX8gc.gif&ehk=KUdjPcBBkT%2fjY0VxirZWUyUob6J0qb5M73sJqKYFXbA%3d";
            lion = lion + 1; 
        }
